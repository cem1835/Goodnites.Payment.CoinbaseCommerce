...
namespace Goodnites.Payment.CoinbaseCommerce.Migrations
{
    public partial class SMM_CoinbaseInitial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoinbaseCommercePayments", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "CoinbaseCommerceRefunds",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoinbaseCommerceRefunds", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "CoinbaseCommercePaymentItems",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoinbaseCommercePaymentItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CoinbaseCommercePaymentItems_CoinbaseCommercePayments_Payme~",
                        column: x => x.PaymentId,
                        principalTable: "CoinbaseCommercePayments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateTable(
                name: "CoinbaseCommerceRefundItems",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CoinbaseCommerceRefundItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CoinbaseCommerceRefundItems_CoinbaseCommerceRefunds_RefundId",
                        column: x => x.RefundId,
                        principalTable: "CoinbaseCommerceRefunds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoinbaseCommercePaymentItems_PaymentId",
                table: "CoinbaseCommercePaymentItems",
                column: "PaymentId");

            migrationBuilder.CreateIndex(
                name: "IX_CoinbaseCommerceRefundItems_RefundId",
                table: "CoinbaseCommerceRefundItems",
                column: "RefundId");
        }
